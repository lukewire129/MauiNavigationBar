...
namespace MauiNavigationBar.Animations
{
    ...
    {
        public static readonly BindableProperty ToColorProperty = BindableProperty.Create ("ToColor", typeof (Color), typeof (ColorAnimation), Colors.Transparent, BindingMode.TwoWay);
